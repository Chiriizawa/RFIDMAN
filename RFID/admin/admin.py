...
def update_teacher_in_db(teacher_db_id, fields: dict):
    ...
    allowed = {"first_name", "middle_name", "last_name", "extension", "contact_number", "email", "birthday"}
...
def upload_teacher_profile_pic():
    ...
    if file:
        ...
        # Walang profile_image column sa screenshot ng teachers table mo
        # Kaya save file lang muna, walang DB update dito
        return jsonify({
            "success": True,
            "image_url": image_url,
